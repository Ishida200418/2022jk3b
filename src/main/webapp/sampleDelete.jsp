...
<body>
	...
	%>
	<p>ID <%=bean.getStudent_ID_Number()%></p>
	<p>氏名 <%=bean.getStudent_Name()%></p>
	<p>氏名 <%=bean.getStudent_Pronunciation()%></p>
	<p>このデータを削除しますか？</p>
	<form method="get" action="deletego">
		<input type="hidden" name="id" value="<%=bean.getStudent_ID_Number()%>">
